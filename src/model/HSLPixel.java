...
public class HSLPixel implements IPixel {
   ...
   * to keep track of a.
   *
   * @param h        the h component for this pixel
   * @param s        the s component for this pixel
   * @param l        the l component for this pixel
   * @param a        the alpha component for this pixel
   * @param maxValue the maximum value for any component of this pixel
   * @throws IllegalArgumentException if any of the given values are invalid for an HSL pixel
   */
   ...
   * @param s        the s component for this pixel
   * @param l        the l component for this pixel
   * @throws IllegalArgumentException if any given component values are invalid for an
   *                                  HSL pixel
   */
  public HSLPixel(int h, double s, double l) throws IllegalArgumentException {
    this.h = h;
    this.s = s;
    this.l = l;
    this.a = 255;
