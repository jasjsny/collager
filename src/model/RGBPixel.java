...
public class RGBPixel implements IPixel {
   ...
   *
   * @param r the red-component for this pixel
   * @param g the green-component for this pixel
   * @param b the blue-component for this pixel
   * @param a the alpha value for this pixel
   * @throws IllegalArgumentException if any of the values are invalid
   */
  public RGBPixel(int r, int g, int b, int a) throws IllegalArgumentException {
    this.r = r;
    this.g = g;
    this.b = b;
    this.a = a;
