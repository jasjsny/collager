...
/**
 * Interface for a layer in a collage project.
 * Supports methods for adding images and applying filters to a layer.
 * Also has observers used to get information about a layer.
 */
public interface ILayer {
   ...
   * @return the copied 2d list of pixels.
   */
   ...
   * @param f the filter which will be set as this layer's filter.
   */
  void setFilter(IFilterOption f);

  /**
   * Sets all IPixels in the layer to know their IPixel below.
   */
   ...
   * @throws IOException if there is an error during the ppm conversion process.
   */
   ...
   * @param other the layer which will be merged on top of this layer
   * @return the merged ILayer, with this layer being the one below
   */
