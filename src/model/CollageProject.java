...
public class CollageProject implements IProject {
  ...
  /**
   * Main constructor for Collage Project. Creates a collage project with the
   * given values. Initializes the list of layers to only contain a background layer
   *
   * @param name   the name for the collage project
   * @param height the height for the collage project
   * @param width  the width for the collage project
   * @throws IllegalArgumentException if name == null
   *        OR if the given values for the height/width of the project are invalid
   */
  public CollageProject(String name, int height, int width) throws IllegalArgumentException {
   ...
   * @param height the height for the collage project
   * @param width  the width for the collage project
   * @param maxPixels the maximum value for an alpha value
   * @throws IllegalArgumentException if name == null
   *        OR if the given values for the height/width of the project are invalid
   *        OR if the given max value is invalid
   */
   ...
   * @param height the height for the collage project
   * @param width  the width for the collage project
   * @param layers the layers which this project will be created with
   * @throws IllegalArgumentException if name == null
   *        OR if the given values for the height/width of the project are invalid
   */
  ...
  /**
   * Returns all the layers of this collage project as a list.
   *
   * @return the collection of layers in this project as a list.
   */
  @Override
  ...
  /**
   * Formats this collage project into a .collage text format.
   *
   * @return this collage project as a text format, represented as a String.
   */
  ...
  public IPixel[][] doubleArrayRGB(int height, int width) throws IllegalArgumentException {
    return new RGBPixel[height][width];
  }

  @Override
  public IPixel createRGB(int r, int g, int b, int maxVal) throws IllegalArgumentException {
    return new RGBPixel(r, g, b, maxVal);
  }

  @Override
  public ILayer createLayerImp(String name, List<List<IPixel>> pix, int height, int width)
          throws IllegalArgumentException {
    return new CollageLayer(name, pix, height, width);
  }

  @Override
  public IPixel createRGBA(int r, int g, int b, int a) {
    return new RGBPixel(r, g, b, a);
  }
}
