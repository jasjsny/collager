...
/**
 * SetGameProgram is the class for running the collage project through the method Main().
 */
public final class RunCollage {

  /**
   * Method, required to be named main, is used to run the collage project in the console.
   */
